...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "sdsagor8187@mail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "01754718187",
  },
];
  ...
  return (
    <div className="relative -bottom-15 -mt-15 z-10 px-2">
      ...
      <div
        ...
        id="contact"
      >
        <h1 className="text-center font-bold text-4xl pb-5">Contact</h1>
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                If you need a responsive, user-friendly, and high-performance website, let’s connect and build something amazing together.
              </p>
            </div>
